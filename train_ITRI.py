import time
#from net_BnoSeg import *
from models.net_ITRIGAN import *
...
def main(
        ...
        which_direction, workers, display_freq, style_a, style_b, phase, opt_choice):
    ...
    net = GANModel(
        ...
        display_freq=display_freq, use_sigmoid=True, name=name,
